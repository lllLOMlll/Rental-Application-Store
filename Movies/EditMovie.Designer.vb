...
Partial Class EditMovie
    ...
    Private Sub InitializeComponent()
        ...
        Label_Title.Size = New Size(271, 65)
        Label_Title.TabIndex = 0
        Label_Title.Text = "Edit Movie"
        ' 
        ' Label_Title_Movie
        ' 
        ...
        Label_Poster_URL.Location = New Point(1037, 506)
        ...
        TextBox3.Location = New Point(1037, 530)
        ...
        ' Button_Edit_Movie
        ' 
        Button_Edit_Movie.BackColor = Color.White
        Button_Edit_Movie.FlatAppearance.BorderColor = Color.Black
        Button_Edit_Movie.FlatAppearance.BorderSize = 4
        Button_Edit_Movie.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(245), CByte(200), CByte(35))
        Button_Edit_Movie.FlatStyle = FlatStyle.Flat
        Button_Edit_Movie.Font = New Font("Segoe UI Semibold", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Edit_Movie.ForeColor = Color.Black
        Button_Edit_Movie.Location = New Point(572, 630)
        Button_Edit_Movie.Name = "Button_Edit_Movie"
        Button_Edit_Movie.Size = New Size(192, 65)
        Button_Edit_Movie.TabIndex = 22
        Button_Edit_Movie.Text = "EDIT MOVIE"
        Button_Edit_Movie.UseVisualStyleBackColor = False
        ' 
        ' Button_Clear
        ' 
        ...
        Button_Upload_Picture_URL.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Upload_Picture_URL.ForeColor = Color.Black
        Button_Upload_Picture_URL.Location = New Point(1037, 565)
        Button_Upload_Picture_URL.Name = "Button_Upload_Picture_URL"
        Button_Upload_Picture_URL.Size = New Size(407, 36)
        ...
        Button_Upload_Picture_Download.Font = New Font("Segoe UI", 12F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Upload_Picture_Download.ForeColor = Color.Black
        Button_Upload_Picture_Download.Location = New Point(1037, 442)
        Button_Upload_Picture_Download.Name = "Button_Upload_Picture_Download"
        Button_Upload_Picture_Download.Size = New Size(204, 53)
        Button_Upload_Picture_Download.TabIndex = 30
        Button_Upload_Picture_Download.Text = "Upload Picture "
        ...
        Label_Status.Location = New Point(102, 629)
        ...
        ComboBox_Status.Location = New Point(102, 653)
        ComboBox_Status.Name = "ComboBox_Status"
        ComboBox_Status.Size = New Size(161, 29)
        ...
        Button_Clear_Genre.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Clear_Genre.ForeColor = Color.Black
        Button_Clear_Genre.Location = New Point(447, 219)
        Button_Clear_Genre.Name = "Button_Clear_Genre"
        Button_Clear_Genre.Size = New Size(61, 29)
        Button_Clear_Genre.TabIndex = 34
        ...
        Button_Clear_Language.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Clear_Language.ForeColor = Color.Black
        Button_Clear_Language.Location = New Point(447, 358)
        Button_Clear_Language.Name = "Button_Clear_Language"
        Button_Clear_Language.Size = New Size(61, 29)
        Button_Clear_Language.TabIndex = 35
        ...
        Button_Clear_Country.Font = New Font("Segoe UI", 9F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Clear_Country.ForeColor = Color.Black
        Button_Clear_Country.Location = New Point(447, 572)
        Button_Clear_Country.Name = "Button_Clear_Country"
        Button_Clear_Country.Size = New Size(61, 29)
        Button_Clear_Country.TabIndex = 36
        ...
        Button_Dashboard.Location = New Point(550, 46)
        ...
        Controls.Add(Button_Edit_Movie)
    ...
    Friend WithEvents Button_Edit_Movie As Button
