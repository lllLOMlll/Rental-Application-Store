...
Partial Class EditListMovies
    ...
    Private Sub InitializeComponent()
        ...
        DataGridView_Movies_List = New DataGridView()
        ...
        CType(DataGridView_Movies_List, ComponentModel.ISupportInitialize).BeginInit()
        ...
        Label_Title.Size = New Size(384, 65)
        Label_Title.TabIndex = 0
        Label_Title.Text = "Edit Movies List"
        ' 
        ' DataGridView_Movies_List
        ' 
        DataGridView_Movies_List.AllowUserToDeleteRows = False
        DataGridView_Movies_List.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        DataGridView_Movies_List.Location = New Point(38, 128)
        DataGridView_Movies_List.Name = "DataGridView_Movies_List"
        DataGridView_Movies_List.ReadOnly = True
        DataGridView_Movies_List.RowTemplate.Height = 25
        DataGridView_Movies_List.Size = New Size(1277, 580)
        DataGridView_Movies_List.TabIndex = 1
        ' 
        ...
        Button_Dashboard.FlatAppearance.BorderSize = 5
        ...
        Button_Dashboard.Location = New Point(575, 55)
        ...
        Controls.Add(DataGridView_Movies_List)
        Controls.Add(Label_Title)
        Name = "EditListMovies"
        StartPosition = FormStartPosition.CenterScreen
        Text = "Movies List"
        CType(DataGridView_Movies_List, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents DataGridView_Movies_List As DataGridView
