...
Partial Class DeleteListMovies
    ...
    Private Sub InitializeComponent()
        ...
        Label_Title.Size = New Size(441, 65)
        Label_Title.TabIndex = 0
        Label_Title.Text = "Delete Movies List"
        ' 
        ...
        Button_Dashboard.Location = New Point(605, 55)
