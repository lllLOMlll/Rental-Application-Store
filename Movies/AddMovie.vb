...
Public Class AddMovie
    ...
    Private Sub AddMovie_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' Set the starting year to 2023
        DomainUpDown_Release_Year.Text = "2023"
    End Sub

    Private Sub PopulateYearsDomainUpDown()
        ' Define the range of years
        Dim startYear As Integer = 2100  ' Start from the later year
        Dim endYear As Integer = 1900    ' End at the earlier year
    ...
    Private Sub PictureBox1_Click(sender As Object, e As EventArgs) Handles PictureBox_Poster.Click

    End Sub

    ' ADD A MOVIE
    Private Sub Button_Add_Movie_Click(sender As Object, e As EventArgs) Handles Button_Add_Movie.Click
        ...
        Dim newMovie As New Movie()
            newMovie.Photo = picturePath
            newMovie.Title = TextBox_Title.Text
            newMovie.Year = DomainUpDown_Release_Year.Text
            newMovie.Country = TextBox_Countries.Text
            newMovie.Language = TextBox_Original_Language.Text
            newMovie.Length = Integer.Parse(TextBox_Run_Time.Text) ' Make sure to validate and convert to Integer
            newMovie.Resume = TextBox_Resume.Text
            newMovie.Genre = TextBox_Genre.Text
            newMovie.Actors = TextBox_Starring.Text
            newMovie.Director = TextBox_Director.Text
            newMovie.Status = Movie.MovieStatus.Available ' Set default status or based on some logic
        ...
        Try
                ...
                MsgBox($"{title} has been successfully added to the database", MsgBoxStyle.Information, "New movie")
