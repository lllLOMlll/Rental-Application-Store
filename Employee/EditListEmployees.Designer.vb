...
Partial Class EditListEmployees
    ...
    Private Sub InitializeComponent()
        ...
        Label_Title.Size = New Size(657, 65)
        Label_Title.TabIndex = 0
        Label_Title.Text = "Choose an employee to edit"
        ' 
        ...
        Button_Dashboard.Location = New Point(769, 55)
