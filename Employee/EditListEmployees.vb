Public Class EditListEmployees
    ...
    Private Sub DataGridView_List_Employees_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView_List_Employees.CellClick
        ...
        If e.RowIndex >= 0 Then
            ...
            Dim result As DialogResult = MessageBox.Show(userDetails.ToString() & vbCrLf & "Do you want to update this user?", "Employee Details", MessageBoxButtons.YesNo, MessageBoxIcon.Question)

            If result = DialogResult.Yes Then
                ' User chose to update the user               
                Globals.EmployeeNumberEdit = selectedRow.Cells("employee_number").Value.ToString()
                ShowSelectedForm(Me, New EditEmployee)
            End If
        End If
    End Sub
