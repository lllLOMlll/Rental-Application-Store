...
Partial Class AddClient
    ...
    Private Sub InitializeComponent()
        ...
        Label_Title.Size = New Size(267, 65)
        Label_Title.TabIndex = 0
        Label_Title.Text = "Add Client"
        ' 
        ' Label_Username
        ' 
        ...
        ' Button_Add_Client
        ' 
        Button_Add_Client.BackColor = Color.White
        Button_Add_Client.FlatAppearance.BorderColor = Color.Black
        Button_Add_Client.FlatAppearance.BorderSize = 4
        Button_Add_Client.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(245), CByte(200), CByte(35))
        Button_Add_Client.FlatStyle = FlatStyle.Flat
        Button_Add_Client.Font = New Font("Segoe UI", 14.25F, FontStyle.Bold, GraphicsUnit.Point)
        Button_Add_Client.ForeColor = Color.Black
        Button_Add_Client.Location = New Point(77, 624)
        Button_Add_Client.Name = "Button_Add_Client"
        Button_Add_Client.Size = New Size(221, 76)
        Button_Add_Client.TabIndex = 35
        Button_Add_Client.Text = "ADD CLIENT"
        Button_Add_Client.UseVisualStyleBackColor = False
        ' 
        ' Button_Clear
        ' 
        ...
        Button1.FlatAppearance.MouseOverBackColor = Color.FromArgb(CByte(245), CByte(200), CByte(35))
        Button1.FlatStyle = FlatStyle.Flat
        Button1.Font = New Font("Segoe UI", 15.75F, FontStyle.Bold, GraphicsUnit.Point)
        Button1.ForeColor = Color.Black
        Button1.Location = New Point(520, 64)
    ...
    Friend WithEvents Button_Add_Client As Button
